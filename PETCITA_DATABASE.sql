...
CREATE TABLE cat_servico (
	...
	servico_interno boolean NOT NULL,
...
CREATE TABLE pedido_agendamento (
    ...
    FOREIGN KEY (id_pedido) REFERENCES pedido(id_pedido),
    FOREIGN KEY (id_cat_servico) REFERENCES cat_servico(id_cat_servico),
	FOREIGN KEY (id_animal) REFERENCES animal(id_animal)
);
*/

CREATE TABLE pedido_item (
	id_pedido_item int auto_increment NOT NULL,
	id_cat_produto int NOT NULL,
	quantidade int NOT NULL,
	data_pedido date NOT NULL,
	id_usuario int NOT NULL,
...
CREATE TABLE pedido_agendamento (
	id_pedido_agendamento int auto_increment NOT NULL,
    	id_cat_servico int NOT NULL,
    	id_animal int NOT NULL,
	data_agendamento date NOT NULL,
    	id_usuario int NOT NULL,
