...
// Getters e Setters:
    ...
    {
        String SQL = String.format("INSERT INTO animal (id_animal, nome, especie, data_nascimento, porte, cliente_id) VALUES (%d, '%s', '%s', '%s', '%c', %d)", this.getId_animal(), this.getNome(), this.getEspecie(), this.getDataNascimento(), this.getPorte(), this.getIdCliente());

        this.setId_animal(DataBaseUtils.insertRetornaId(conn, SQL));
